workspace "Environmental Observations" "POC for Environmental Observations" {
    ...
    model {
        enterprise = enterprise "Council"  {
            hydrotel = softwaresystem "Hydrotel System" "Hydrotel where Telemetary data lands first." "Existing System"
            ...
            manager = person "Data Manager" "Person who QA's Telem data" "Council Staff" 

            core = group "Environmental Observations Core" {                
                eom = softwareSystem "Aquisition and Management" "Where new Observations are landed and QA processes done. Transactional side of managing data e.g. Managing which Telem data requires QA, and tools to apply quality codind"
        ...
        field_devices = softwaresystem "Council Telem Devices" "Council Managed Telemetary capturing devices." "Existing System"
        ...
        field_devices -> hydrotel "Sending latest readings to"
        ...
        manager -> eom "Reviews telem data and marks as QA'ed"
